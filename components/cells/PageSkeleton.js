...
const PageSkeleton = () => {
    return (
        <VStack align='center' w='100%' maxW='1200px'>
            <Skeleton w={ { base: '80%', md: '60%' } } h='52px' maxW='350px' />
            <Skeleton w={ { base: '95%', md: '80%' } } h='52px' maxW='460px' />
            ...
            <VStack w='100%' mt={ { base: 10, md: 16 } } gap={ { base: 4, md: 8 } }>
                <VStack w='100%'>
                    <HStack w={ { base: '100%', md: '65%' } } maxW='500px'>
                        <SkeletonCircle size='8' />
                        <SkeletonText noOfLines={ 1 } w='30%' height={ { base: '20px', md: '12px' } } />
                    ...
                    <Skeleton w={ { base: '100%', md: '65%' } } h='52px' maxW='500px' />
                </VStack>
                <VStack w='100%'>
                    <HStack w={ { base: '100%', md: '65%' } } maxW='500px'>
                        <SkeletonCircle size='8' />
                    ...
                    <VStack w={ { base: '100%', md: '65%' } } alignItems='flex-start' maxW='500px'>
                        <Skeleton w='100%' h='52px' />
                        <SkeletonText noOfLines={ 1 } w='40%' height={ { base: '20px', md: '12px' } } />
